...
Description: 
	Go into Opera history; list visited sites and the
...
#open Opera History file; get the lines; close the file
open FILE, "$dir/AppData/Roaming/Opera Software/Opera Stable/History" or die "File doesn't exist!\n";
my @lines = <FILE>;
close FILE;
...
my $workbook  = Spreadsheet::WriteExcel->new( 'OperaResult.xls' );
